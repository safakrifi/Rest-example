...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleNotFoundException(BeanNotFoundException ex,
			WebRequest request) {
		String error = ex.getMessage();
		ApiError apiError = new ApiError(new Date(),HttpStatus.NOT_FOUND, ex.getLocalizedMessage(), error,request.getDescription(false));
	...
	protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
		...
		ApiError apiError = new ApiError(new Date(),HttpStatus.BAD_REQUEST, ex.getLocalizedMessage(), error,request.getDescription(false));
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
...
//	violations de contrainte
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
		...
		ApiError apiError = new ApiError(new Date(),HttpStatus.METHOD_NOT_ALLOWED, ex.getLocalizedMessage(), builder.toString(),request.getDescription(false));
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}

	@ExceptionHandler({ Exception.class })
	public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
		ApiError apiError = new ApiError(new Date(),HttpStatus.INTERNAL_SERVER_ERROR, ex.getLocalizedMessage(), "error occurred",request.getDescription(false));
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		ApiError apiError = new ApiError(new Date(),HttpStatus.BAD_REQUEST,"please check entered information syntax", builder.toString(),request.getDescription(false));
		return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
	}
}